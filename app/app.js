...
app.get("/assignments/:assignment_id/submissions", function (req, res) {
    if (validator.isInt(req.params['assignment_id'])) {
...
app.get("/users/:user_id/groups", function (req, res) {
    if (validator.isInt(req.params['user_id'])) {
...
app.get("/users/:user_id/submissions", function (req, res) {
    if (validator.isInt(req.params['user_id'])) {
...
app.get("/groups/:group_id/users", function (req, res) {
    if (validator.isInt(req.params['group_id'])) {
...
app.get("/groups/:group_id/assignments", function (req, res) {
    if (validator.isInt(req.params['group_id'])) {
